...
public class StoreToSave {
	...
	public void storeInHash(String type,String fill, Long previd, Long id, String border, boolean flag,double[] additional, String label) {
		String[] shapeAttributes = new String[11];
