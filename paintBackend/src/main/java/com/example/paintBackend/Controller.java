...
public class Controller {
    ...
    @GetMapping("/store")
    public void storing(@RequestParam String type, @RequestParam String fill, @RequestParam long previd, @RequestParam long id, @RequestParam String border,@RequestParam String label, @RequestParam boolean flag, @RequestParam double additionalAttributes[]) {
    	StoreToSave storeToSave = new StoreToSave();
    	storeToSave.storeInHash(type, fill, previd, id, border, flag, additionalAttributes,label);
    }
